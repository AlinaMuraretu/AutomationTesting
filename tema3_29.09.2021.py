...
#lst=[55, 6, 777, 54, 6, 76, 101, 1, 6, 2, 6]
#Metoda remove in lista de mai sus sterge primul 6. Nu se poate folosi in cazul asta
#Se poate folosi metoda pop
lst=[55, 6, 777, 54, 6, 76, 101, 1, 6, 2, 6]
lst.pop(-1)
print(lst)
